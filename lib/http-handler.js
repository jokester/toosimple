    ...
    function indexHTML(fs, log, render, root) {
        ...
        return (req, res, next) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const html = yield render.dirIndex(yield templateStr, realPath, root, children);
    ...
    function indexJSON(fs, log, root) {
        return (req, res, next) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const items = yield fs.readDirDetail(realPath);
...
exports.createHandler = (fs, log, render, root) => {
