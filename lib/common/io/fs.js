...
(function (FSImpl) {
    ...
    FSImpl.mv = mv;
    FSImpl.readDir = promisify_1.Callback2Promise.toPromise1(fs.readdir);
    FSImpl.readFile = promisify_1.Callback2Promise.toPromise1(fs.readFile);
    FSImpl.readText = promisify_1.Callback2Promise
        .toPromise2(fs.readFile);
    FSImpl.lstat = promisify_1.Callback2Promise.toPromise1(fs.lstat);
    FSImpl.stat = promisify_1.Callback2Promise.toPromise1(fs.stat);
    FSImpl.unlink = promisify_1.Callback2Promise.toPromise1v(fs.unlink);
    FSImpl.mkdtemp = promisify_1.Callback2Promise.toPromise1(fs.mkdtemp);
    FSImpl.rmdir = promisify_1.Callback2Promise.toPromise1v(fs.rmdir);
    // NOTE 'rename' (and POSIX 'rename' syscall) is limited to same filesystem.
    FSImpl.rename = promisify_1.Callback2Promise.toPromise2v(fs.rename);
    FSImpl.writeFile = promisify_1.Callback2Promise.toPromise2v(fs.writeFile);
    /**
     *
     *
     * @export
